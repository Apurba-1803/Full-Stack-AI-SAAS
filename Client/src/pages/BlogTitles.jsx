  ...
  return (
      ...
      >
        <div className="flex items-center gap-3">
          <Atom className="w-6 text-[#8E37EB]" />
        ...
        <div className="mt-3 flex gap-3 flex-wrap sm:max-w-9/11">
          {blogCategories.map((item) => (
            <span
              ...
              key={item}
              className={`text-xs px-4 p-1 border rounded-full cursor-pointer ${selectedCategory === item ? "bg-purple-50 text-purple-700" : "text-gray-500 border-gray-300"}`}
            >
              {item}
            </span>
          ))}
